...
public class MyViewGroup extends ViewGroup {
	...
	/**
	 * 当从xml将所有的控件都调入内存后，触发的动作 在这里获取控件的大小，并计算整个ViewGroup需要的总的宽和高
	 */
	@Override
	protected void onFinishInflate() {
		...
		// Log.v("Finish Inflate:",
		// "btnWidth="+mButtonWidth+",btnHeight="+mButtonHeight+",padding:"+mPaddingLeft+","+mPaddingTop+","+mPaddingRight+","+mPaddingBottom);
	 ...
	 * 调用每个键的layout，将他们一个一个布局好 就是4*3的放置，很简单，一个嵌套循环搞定
	 */
	@Override
