...
public class PriceViewGG extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		priceListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (listData.size() > position) {
					...
					Intent in = new Intent(PriceViewGG.this, DetailTab.class);
		...
		progressDialog = new ProgressDialog(PriceViewGG.this);
	...
	public void showNew() {
		...
		for (int i = 0; i < mData.size(); i++) {
			...
			if (code.equals(timeNow.getPrice_code())) {
				...
				map.put(Const.PRICE_LASTSETTLE, timeNow.getPrice_lastsettle());
	...
	protected void authorDialog() {
		AlertDialog.Builder builder = new Builder(PriceViewGG.this);
	...
	private void showNoConn() {
		// TODO Auto-generated method stub
		new AlertDialog.Builder(PriceViewGG.this).setTitle("注意：")
